...
analyse_numerical_variable <- function(dt_to_analyse_filename, variable_to_plot, plot_type, plot_axis_title_filename) {
 ...
 if(plot_type == "raincloud") {
  ...
  variable_rp <- ggplot(data = dt_to_analyse, aes(x = transcriptome, y = .data[[variable_to_plot]], fill = transcriptome)) +
   stat_halfeye(normalize = "groups", justification = -0.1, width = 0.9, .width = 0, point_colour = NA, alpha = 0.8) +
...
#Displaying general transcriptome assembly statistics kable
...
#Displaying transcript score component statistics and assembly scores kable
...
#Displaying transcript score raincloud plot
...
#Displaying coverage and accuracy statistics kable
...
#Displaying per-base coverage barplot
analyse_categorical_variable("per_base_coverage_distribution.tsv", "coverage_category", "Base coverage")
knitr::include_graphics(paste("base_coverage", FIGURE_EXT, sep = "."))
```
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying proportion of covered bases per transcript barplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying mean transcript coverage barplot
...
#Displaying positional relative coverage lineplot
...
#Displaying maximum uncovered region length per transcript histogram
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`HI_HEIGHT`, fig.width=`HI_WIDTH`}
#Displaying mean transcript end coverage per transcript histogram
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying proportion of bases in low-coverage regions per transcript barplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`HI_HEIGHT`, fig.width=`HI_WIDTH`}
#Displaying low-coverage region length histogram
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`RP_HEIGHT`, fig.width=`RP_WIDTH`}
#Displaying coverage score component raincloud plot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying per-base accuracy barplot
analyse_categorical_variable("per_base_accuracy_distribution.tsv", "accuracy_category", "Base accuracy")
knitr::include_graphics(paste("base_accuracy", FIGURE_EXT, sep = "."))
```
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying proportion of accurate bases per transcript barplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`LP_HEIGHT`, fig.width=`LP_WIDTH`}
#Displaying positional accuracy lineplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying proportion of bases in low-accuracy regions per transcript barplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`HI_HEIGHT`, fig.width=`HI_WIDTH`}
#Displaying low-accuracy region length histogram
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`RP_HEIGHT`, fig.width=`RP_WIDTH`}
#Displaying accuracy score component raincloud plot
...
#Displaying local fidelity and integrity statistics kable
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying per-transcript proportion of improperly paired reads within a transcript barplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`RP_HEIGHT`, fig.width=`RP_WIDTH`}
#Displaying local fidelity score component raincloud plot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=5, fig.width=`BP_WIDTH`}
#Displaying per-transcript proportion of reads with pair mapped to another transcript barplot
...
```{r echo=F, message=F, warning=F, fig.align='center', fig.height=`RP_HEIGHT`, fig.width=`RP_WIDTH`}
#Displaying integrity score component raincloud plot
